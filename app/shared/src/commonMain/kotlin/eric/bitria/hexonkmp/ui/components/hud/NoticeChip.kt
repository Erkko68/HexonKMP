...
// Green chip for in-game contextual prompts (robber move, road building, notices).
// Wraps onto multiple lines on narrow screens; the caller sizes it via [modifier].
@Composable
