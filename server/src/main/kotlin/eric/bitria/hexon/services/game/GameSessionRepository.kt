...
interface GameSessionRepository {
    ...
    fun addSession(mode: GameMode, session: BaseGameSession)

    /** Remove session (finished or abandoned) */
    fun removeSession(mode: GameMode, sessionId: String)

    /** Lookup a session by id */
    fun getSession(sessionId: String): BaseGameSession?

    /** Find a session with available slots for the given mode */
    fun findAvailableSession(mode: GameMode): BaseGameSession?
}
