...
class LoginRoutesEmailTest {
    ...
    @Test
    fun `login returns INVALID_EMAIL_OR_PASSWORD for malformed email`() =
    ...
    @Test
    fun `login returns INVALID_EMAIL_OR_PASSWORD if email is too long`() =
        withTestAuthClient { client, _ ->
    ...
    @Test
    fun `login returns INVALID_EMAIL_OR_PASSWORD if email is empty`() =
        withTestAuthClient { client, _ ->
