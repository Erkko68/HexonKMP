...
class LoginRoutesPasswordTest {
    ...
    @Test
    fun `login returns INVALID_EMAIL_OR_PASSWORD if password is too long`() =
    ...
    @Test
    fun `login returns INVALID_EMAIL_OR_PASSWORD for weak password`() =
        withTestAuthClient { client, _ ->
    ...
    @Test
    fun `login returns INVALID_EMAIL_OR_PASSWORD if password is empty`() =
        withTestAuthClient { client, _ ->
